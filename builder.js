(function () {
  ...
  const configs = {
    "l0-space": {
      ...
      fields: [
        ...
        ["style_reference", "What visual style do you want?", "Realistic documentary render, clean product mock-up, cosy workshop, gentle science-fiction, low-poly three-dimensional (3D) model, architectural cutaway, diagrammatic isometric."],
    ...
    "l1-place": {
      ...
      fields: [
        ...
        ["accuracy_rules", "What details do you want kept accurate?", "Keep Straddie scale modest, separate 9 Ballow from 10-12 Ballow, do not invent ownership, keep the planned Quandamooka arts, museum and performance precinct and ferry context source-aware."],
    ...
    "l2-boundary": {
      ...
      schema: "straddie.prompt_builder.l2_bioregion_scale_brief.v1",
      scale: "Level 2 (L2)",
      guidance: "Use this for bioregion-scale briefs: island chains, bays, watersheds, ferry corridors, wetlands, catchments and shared responsibility questions.",
      fields: [
        ["scene_or_space", "What bioregion-scale world do you want prepared?", "Minjerribah and Moreton Bay, the ferry corridor, Dunwich/Gumpi gateway, wetland edge, bay catchment flow, island-chain resilience map."],
        ["simulation_goal", "What do you want the external tool to make visible?", "Tide, ferry pressure, visitor movement, storm surge, heat, wetlands, public screens, water logic, ecological sensitivity, civic response."],
        ...
        ["negative_prompt", "What do you want left out?", "Dystopian flood panic, raw household dots, fake official-looking seal, dramatic disaster clickbait, secret-place exposure."],
        ...
        ["iteration_handoff", "What do you want the next external run to test?", "Everyday ferry pulse, storm fallback, heatwave rest network, wetland education view, public-screen network, quieter tourism scenario."]
      ]
    },
    "simulation-brief": {
      ...
      fields: [
        ...
        ["accuracy_rules", "What do you want source-labelled?", "Public dates, property status, health claims, emergency advice, cultural source and permission choices, ecological layers and live infrastructure state."],
        ["negative_prompt", "What do you want left out?", "Guaranteed predictions, fake emergency instruction, private-person tracking, false clinical advice, official-looking seal."],
    ...
    "scene-space": {
      ...
      fields: [
        ...
        ["style_reference", "What style do you want the generator to follow?", "Realistic, cinematic but calm, planning-table model, watercolour concept, low-poly prototype, documentary photograph, three-dimensional (3D) render."],
  ...
  function buildMarkdown() {
    ...
    return [
      ...
      "# " + title,
      "",
      "This file is a self-sovereign prompt packet for outside visual generators, video generators, three-dimensional (3D) and four-dimensional (4D) world builders, game prototypes or simulation tools. It turns plain English choices into an accurate, customisable brief for the next system.",
      "",
      ...
      "- Level 2 (L2) prompt briefs use public-source context and summaries people choose to share.",
      "- Use placeholders when real names, private notes, logos, official-looking seals or identifiable people are not part of the chosen output.",
      "",
      "## Linked Public Doors",
      "",
