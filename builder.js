(function () {
  ...
  const configs = {
    ...
    "l1-place": {
      ...
      examples: {
        scene: "A realistic photo of a shaded public information and seating zone near an island ferry terminal.",
        place: "Dunwich (Gumpi/Goompi) ferry terminal upgrade area, public-safe community concept image.",
        focal: "One shaded seating and information area beside the ferry approach.",
        ...
        middle: "Shade canopy, bench, blank information board, ferry approach path.",
        background: "Bay water, ferry terminal shapes, coastal trees and road edge.",
        materials: "Weathered timber, dull metal, paper, sand, teal paint and coastal planting.",
        movement: "Two anonymous locals walking through the area, no readable faces.",
        accuracy: "Label it as a community concept; do not show fake government approval, real private notices or an official final design.",
        references: "GoPro Max 360 ferry-area photos for the place; one material photo for colours.",
        assets: "Shade canopy; bench; path; blank information board; ferry approach; coastal trees.",
        states: "Make a second version with a busier queue and light rain.",
        controls: "Time of day; crowd level; shade size; weather; camera distance.",
        negative: "Fake logos, readable private notices, luxury-resort look, panic scene, real faces, official approval stamp.",
        iteration: "Make the scene more recognisably local and less busy.",
        visible: "Path edge, sandy ground, low planting, shade canopy, bench, blank information board, bay water, ferry terminal shapes and coastal trees.",
        next: "Make a second version with a busier queue and light rain."
      }
    },
    "l2-boundary": {
