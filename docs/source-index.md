...
- `Sovereign_Space_Builder__Full_System_Specification.md`
- `Sovereign_Space_Builder__Full_System_Specification_(2).md`
- `_Island's_Locus_of_Control_Narrative_.md`
- `Middle_Way_Compute_and_Data_Strategy.md`
- `AI_Security,_Twins,_Vibes_.md`
- `Quandamooka_Country_Events_Engine.md`
- `A_Strategic_Straddie_Dossier.md`
